...
## NormalizeWrapperEnv {#NormalizeWrapperEnv}
...
## ScalingWrapperEnv {#ScalingWrapperEnv}
...
::: warning ScalingWrapperEnv requires finite bounds on observation and action spaces. It will not work with spaces containing `Inf` or `-Inf` bounds. :::

## MonitorWrapperEnv {#MonitorWrapperEnv}
